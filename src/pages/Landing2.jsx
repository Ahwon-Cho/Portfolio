...
import PlanetScene3D from '../components/TheaterScene3D'
...
const CHAPTERS = [
  {
    ...
    description: 'I’m Ahwon. I turn complex workflows into clear, thoughtful experiences—with visual design at the heart of how I solve problems.',
  ...
  },
  {
    ...
    description: 'Coffee gives me a moment to observe, question, and find the first thread worth following.',
  ...
  },
  {
    ...
    description: 'This is where visual craft, systems thinking, and close collaboration turn ambiguity into something people can use.',
  ...
  },
  {
    ...
    description: 'Planting tomatoes and zucchinis reminds me that meaningful progress comes from curiosity, patience, and consistent care.',
...
export default function Landing2() {
  ...
  return (
    <section
      ref={storyRef}
      className="planet-story modern-story"
      ...
      <div className="planet-sticky">
        ...
        <div className="planet-frame">
          ...
          <button
            ...
            onClick={() => navigate('/work2')}
          />

          <button type="button" className="planet-skip" onClick={() => navigate('/work2')}>
            Skip to work <Arrow />
          </button>
        </div>
